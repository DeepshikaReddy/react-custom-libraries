...
function getWindow(node) {
  return (0, import_helpers.getWindowFromNode)(node);
}
...
function createDataTransferStub(window2) {
  return new class DataTransferStub {
    getData(format2) {
      var ref;
      const match = (ref = this.items.find(getTypeMatcher(format2, true))) !== null && ref !== void 0 ? ref : this.items.find(getTypeMatcher(format2, false));
      let text = "";
...
function walkNodes(node, direction, callback) {
  for (; ; ) {
    ...
    } else if (node.parentNode && (!isElement3(node.parentNode) || !isContentEditable(node.parentNode) && node.parentNode !== ((ref = node.ownerDocument) === null || ref === void 0 ? void 0 : ref.body))) {
...
var import_event_map = __toESM(require_event_map(), 1);
var eventMap2 = {
  ...import_event_map.eventMap,
  click: {
    EventType: "PointerEvent",
    defaultInit: {
      bubbles: true,
...
var eventMapKeys = Object.fromEntries(Object.keys(eventMap2).map((k) => [
  k.toLowerCase(),
  k
]));
function getEventClass(type3) {
  const k = eventMapKeys[type3];
  return k && eventMap2[k].EventType;
}
var mouseEvents = [
  "MouseEvent",
  "PointerEvent"
...
function createEvent2(type3, target, init) {
  ...
  const { EventType, defaultInit } = eventMap2[eventMapKeys[type3]];
...
function dispatchEvent(target, event, preventDefault = false) {
  ...
  } : (ref = behavior[type3]) === null || ref === void 0 ? void 0 : ref(event, target, this);
  ...
  async release(instance, keyDef, position) {
    ...
    if (!pointer3.isPrevented) {
      ...
      if (!pointer3.isMultitouch) {
        const mousemove1 = this.mouse.move(instance, pointer3.position);
    ...
    value: {
      ...
      set(v) {
        if (v === "") {
          ...
          var ref2;
          valueDescr === null || valueDescr === void 0 ? void 0 : (ref2 = valueDescr.set) === null || ref2 === void 0 ? void 0 : ref2.call(el, v);
        }
      }
    },
    type: {
...
async function upload(element, fileOrFiles) {
  ...
  const fileDialog = () => {
    var ref;
    if (files.length === ((ref = input2.files) === null || ref === void 0 ? void 0 : ref.length) && files.every((f, i) => {
      var ref2;
      return f === ((ref2 = input2.files) === null || ref2 === void 0 ? void 0 : ref2.item(i));
    })) {
      return;
    }
...
function createInstance(config2, system = new System()) {
  ...
  return {
    instance,
    api: {
      ...Object.fromEntries(Object.entries(api_exports).map(([name, api]) => [
        name,
